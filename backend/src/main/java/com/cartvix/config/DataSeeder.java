...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        try {
            ...
            System.out.println("Cartvix: Sample products seeded successfully!");

        } catch (Exception e) {
            // Do not crash app startup if seeding fails
            System.out.println("Cartvix: DataSeeder skipped — " + e.getMessage());
        }
    }
}